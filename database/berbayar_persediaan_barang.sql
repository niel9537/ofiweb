...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2019 at 07:03 PM
...
('B000005', 'Amonia Cair', 7, 4, 50, 3, '2017-03-12 16:32:42', 3, '2019-01-25 14:41:07'),
('B000006', 'Asam Sulfate PA 731', 7, 4, 0, 3, '2017-03-12 16:32:59', 3, '2018-07-17 12:05:53'),
('B000007', 'Vitamin Karet Plus Kemasan 1 Kg', 2, 2, 50, 3, '2017-03-12 16:33:15', 3, '2019-01-25 14:38:36');
...
('TM-2019-0000004', '2019-01-25', 'B000007', 50, 1, '2019-01-25 14:38:36'),
('TM-2019-0000005', '2019-01-25', 'B000005', 50, 3, '2019-01-25 14:41:07');
...
CREATE TABLE IF NOT EXISTS `is_jenis_barang` (
`id_jenis` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `is_satuan` (
`id_satuan` int(11) NOT NULL,
...
(1, 'admin', 'Widi Jatmiko, S.Kom', '202cb962ac59075b964b07152d234b70', 'widi.jatmiko99@gmail.com', '082142481381', 'avatar5.png', 'Super Admin', 'aktif', '2016-05-01 08:42:53', '2019-02-28 17:51:32'),
(2, 'manajer', 'Kadina Putri', '202cb962ac59075b964b07152d234b70', 'kadinaputri@gmail.com', '085680892909', 'kadina.png', 'Manajer', 'aktif', '2016-08-01 08:42:53', '2018-07-17 12:03:28'),
(3, 'user', 'Andika Aji Prabowo', '202cb962ac59075b964b07152d234b70', 'andikaaji@gmail.com', '085758858855', '1469574162_users-15.png', 'Gudang', 'aktif', '2017-03-11 14:41:46', '2019-01-25 14:43:24');
...
ALTER TABLE `is_barang`
 ADD PRIMARY KEY (`id_barang`), ADD KEY `id_jenis` (`id_jenis`), ADD KEY `id_satuan` (`id_satuan`), ADD KEY `created_user` (`created_user`), ADD KEY `updated_user` (`updated_user`);

--
-- Indexes for table `is_barang_keluar`
--
ALTER TABLE `is_barang_keluar`
 ADD PRIMARY KEY (`id_barang_keluar`), ADD KEY `id_barang` (`id_barang`), ADD KEY `created_user` (`created_user`);

--
-- Indexes for table `is_barang_masuk`
--
ALTER TABLE `is_barang_masuk`
 ADD PRIMARY KEY (`id_barang_masuk`), ADD KEY `id_barang` (`id_barang`), ADD KEY `created_user` (`created_user`);

--
-- Indexes for table `is_jenis_barang`
--
ALTER TABLE `is_jenis_barang`
 ADD PRIMARY KEY (`id_jenis`), ADD KEY `created_user` (`created_user`), ADD KEY `updated_user` (`updated_user`);

--
-- Indexes for table `is_satuan`
--
ALTER TABLE `is_satuan`
 ADD PRIMARY KEY (`id_satuan`), ADD KEY `created_user` (`created_user`), ADD KEY `updated_user` (`updated_user`);
